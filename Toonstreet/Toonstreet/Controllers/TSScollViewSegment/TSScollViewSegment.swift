...
//class TSScollViewSegment: UISegmentedControl {
//
//
//
//}
 ...
 */
@IBDesignable
@objc public class TSScollViewSegment: UIControl {
    ...
    final private class CollectionViewController : NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
        ...
        private weak var segmentedControl: TSScollViewSegment!
        
        init(segmentedControl:TSScollViewSegment) {
