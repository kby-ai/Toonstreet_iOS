//
//  UpdateComicsCollectionView.swift
//  Toonstreet
//
...
class UpdateComicsCollectionView: UICollectionView {
    ...
    func commonInit(){
        ...
        self.register(UINib.init(nibName: "UpdateComicsCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: UpdateComicsCollectionViewCell.identifer)
...
extension UpdateComicsCollectionView:UICollectionViewDataSource,UICollectionViewDelegate{
...
extension UpdateComicsCollectionView: UICollectionViewDelegateFlowLayout {
