//
//  ReleaseSoonCollectionView.swift
//  Toonstreet
//
...
class ReleaseSoonCollectionView: UICollectionView {
    ...
    func commonInit(){
        ...
        self.register(UINib.init(nibName: "ReleaseSoonCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: ReleaseSoonCollectionViewCell.identifer)
...
extension ReleaseSoonCollectionView:UICollectionViewDataSource,UICollectionViewDelegate{
...
extension ReleaseSoonCollectionView: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let cellWidth = screenWidth * 0.82;
