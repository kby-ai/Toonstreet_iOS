//
//  ContinueReadingCollectionView.swift
//  Toonstreet
//
...
class ContinueReadingCollectionView: UICollectionView {
    ...
    func commonInit(){
        ...
        self.register(UINib.init(nibName: "ContinueReadingCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: ContinueReadingCollectionViewCell.identifer)
...
extension ContinueReadingCollectionView:UICollectionViewDataSource,UICollectionViewDelegate{
...
//            else { preconditionFailure("Failed to load collection view cell") }
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ContinueReadingCollectionViewCell.identifer, for: indexPath) as? ContinueReadingCollectionViewCell
            else { preconditionFailure("Failed to load collection view cell") }
...
extension ContinueReadingCollectionView: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let cellWidth = screenWidth * 0.392;
